...
export default function LoginPage() {
  ...
  const returnTo = useMemo(() => {
    ...
    if (!fromPath) return '/'
    // Avoid loops back into protected routes while auth is not fully wired.
      ...
      <div className={styles.container}>
        <div className={styles.card}>
          <div className={styles.header}>
            <h1>Вход</h1>
            <p>Окно входа открылось справа. Если вы закрыли его — можно открыть снова.</p>
          </div>
          <div className={styles.form}>
            <Button fullWidth onClick={() => openAuthDrawer('login')}>
              Открыть вход
            </Button>
